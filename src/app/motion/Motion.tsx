        ...
        >
          ...
          >
            ...
            <Box flex="1">
              ...
              >
                Popin is the ultimate platform that connects communities with
                unique, local pop-ups and experiences in real time. It’s the
                platform that helps you be discovered, connect with customers,
                and thrive in the moment. Whether you're serving crave-worthy
                eats, showcasing unique goods, or hosting unforgettable events,
                Popin puts your pop-up on the map—literally.
              </Text>
              <Text
                fontSize="lg"
                padding={2}
