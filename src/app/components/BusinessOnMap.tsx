import { Box, Heading, Text, useColorModeValue,Image, Flex,UnorderedList,ListItem } from "@chakra-ui/react";
...
const BusinessOnMap = () => {
  ...
  <Box flex="1" p={10} minW="300px" >
    ...
    <UnorderedList textAlign="left" mt={2} display="flex" flexDirection="column" gap={5} pl={7}>
      ...
      <ListItem ><strong>Grow Your Community: </strong>Attract followers who are excited about your pop-up and keep them updated with real-time notifications and directions.</ListItem>
    </UnorderedList>
  </Box>
